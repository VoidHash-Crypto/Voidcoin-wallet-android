...
export async function getFiatRate(ticker: string): Promise<number> {
  // TODO: VOID is not yet listed on exchanges. These APIs all return BTC prices,
  // which would be misleading. Return 0 until VOID has its own market data feeds.
  console.warn('getFiatRate: VOID price data not yet available from exchanges. Returning 0.');
  return 0;
}
